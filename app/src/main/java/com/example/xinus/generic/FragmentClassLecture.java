 ...
 */
public class FragmentClassLecture extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_fragment_class_lecture, container, false);
         recyclerView = (RecyclerView) v.findViewById(R.id.classlectureRecycleView);
    ...
    public void onStart() {
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Users").child("Class Materials");
